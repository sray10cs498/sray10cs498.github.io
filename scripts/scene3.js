...
//Read the data
d3.csv("/data/bigs_shooting.csv", function(data) {
  console.log(data)
  // Add X axis
  ...
  // A function that change this tooltip when the user hover a point.
   ...
   var mousemove = function(d) {
     ...
     tooltip
       .html('<b>' + d.year + "</b><br>3-Pointers Made: " + d.three_m + "<br>3-Pointers Attempted: "  + d.three_a)
  ...
  svg.append('g')
    ...
    .append("circle")
      ...
      .attr("cy", function (d) { return y(d.three_a); } )
      .attr("r", function (d) { return 50 * d.three_m})
      .style("fill", "#69b3a2")
      .style("opacity", 0.5)
      .style("stroke", "white")
